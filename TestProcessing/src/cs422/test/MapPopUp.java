...
public class MapPopUp
{
     ...
     */
    public MapPopUp(PApplet sketch)
    {
        this(sketch,30,30);
    }
     ...
     */
    public MapPopUp(PApplet sketch, int xBorder, int yBorder)
    {
     ...
     *  @param yBorder Height in pixels of the border to the top and bottom of the popup.
     */
    public MapPopUp(PApplet sketch, PFont font, int xBorder, int yBorder)
    {
        this.sketch = sketch;
        this.font = font;
        ...
        geoMap = new GeoMap(xBorder, yBorder, sketch.width-2*xBorder, sketch.height-2*yBorder, sketch);
    ...
    public void draw()
    {
       ...
       //sketch.background(180, 210, 240);
       sketch.noStroke();//trokeWeight(0.3f);
       sketch.fill(150, 190, 150);
  	   geoMap.draw();
    }
